 ...
 * @returns {{ text: string, provider: string, model: string, usage: { promptTokens: number, completionTokens: number } }}
 */
export function normalizeSuccess(text, provider, model, usage = {}) {
  return {
    text,
    provider,
    model,
