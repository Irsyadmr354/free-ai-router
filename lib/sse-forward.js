 ...
 */
export function writeChunk(res, { id, model, deltaText, finishReason = null, created }) {
  const payload = {
    id,
    ...
    choices: [
      {
        index: 0,
        delta: finishReason === null ? { content: deltaText ?? "" } : {},
 ...
 */
export async function forwardStream(res, req, { id, model, source }) {
